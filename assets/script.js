var questionsBank = [
  ...
  
    {
      ...
      selection: [
        ...
        { choice: "C. A a sequence of characters that can include letters, numbers, symbols, and spaces", answer: true },
  ...
  
    {
      ...
      selection: [
        { choice: "A. It's an ordered list of elements xontaining any data type", answer: false },
        { choice: "B. A collection of properties containing primitive data", answer: true },
        { choice: "A reusable piece of code that can be used to perform a specific task", answer: false },
        { choice: "An action or occurrence that happens as a result of user interaction", answer: false },
      ]
    }
  ];
...
function currentQuestion(){
    ...
    selectedQuestion.selection.forEach(function(selection) {
        ...
        // ansBtn.textContent = selection.choice;
